...
<head>
    ...
    <title>Dashboard | AIM Swift Car Rentals</title>
</head>
...
<body>
    ...
    <main>
        <!-- Banner Section -->
        <section class="banner" style="background-image: url(uploads/banner.svg);">
        ...
        <section class="how-it-works">
            ...
            <div class="steps-container">
                <div class="step">
                    ...
                    <p class="step-description">Browse our selection of sedans, SUVs, and vans. Pick the perfect ride for your trip.</p>
                </div>
                <div class="step">
