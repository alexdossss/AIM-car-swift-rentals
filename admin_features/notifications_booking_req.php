...
<head>
    ...
    <title>Car Booking Requests</title>
</head>
<body>
    ...
    <table>
        ...
        <?php foreach ($bookings as $booking): ?>
            <tr>
                ...
                <td><img src="../display_image.php?id=<?= htmlspecialchars($booking['car_id']) ?>" alt="Car Image" width="200"></td>
                <td><?= $booking['brand'] ?></td>
                <td><?= $booking['model'] ?></td>
    ...
    <?php if (empty($bookings)): ?>
        <p style="color: red;">No Bookings Request Yet.</p>
    <?php endif; ?>
</body>
</html>
